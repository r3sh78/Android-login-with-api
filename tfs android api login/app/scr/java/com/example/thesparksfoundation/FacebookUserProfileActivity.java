...
public class FacebookUserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(FacebookUserProfileActivity.this);
                builder_exitbutton.setTitle("You want to Logout ?")
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast.makeText(FacebookUserProfileActivity.this, "Facebook Logged out successfully!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(FacebookUserProfileActivity.this, MainActivity.class);
