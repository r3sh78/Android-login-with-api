...
public class GoogleUserProfileActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(GoogleUserProfileActivity.this);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(GoogleUserProfileActivity.this);
                                ...
                                Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>() {
                                    ...
                                    public void onResult(@NonNull Status status) {
                                        if(status.isSuccess()){
                                            ...
                                            Toast.makeText(GoogleUserProfileActivity.this, "Gmail Logged out successfully!", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(GoogleUserProfileActivity.this, MainActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }else{
                                            Toast.makeText(GoogleUserProfileActivity.this, "Gmail Log out failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
